        ...
        children: [
          Container(
            ...
            child: const CircleAvatar(
              ...
              child: Text("R", style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
            ),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text("Raj", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                const Text("raj@example.com", style: TextStyle(color: Colors.white54, fontSize: 13, fontWeight: FontWeight.w500)),
